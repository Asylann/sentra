...
-- Returns repositories visible to a workspace (owned by this org via webhooks OR explicitly
-- synced into this workspace). Includes is_linked flag reflecting the user's selection.
